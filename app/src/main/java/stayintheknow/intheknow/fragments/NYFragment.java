...
public class NYFragment extends Fragment {private SwipeRefreshLayout swipeContainer;
    ...
    private void queryArticles() {
        ...
        /*Fetch from api*/
        NYTArticleAPI.getNYTArticles("nyregion");
        ...
        articleQuery.whereEqualTo(Article.KEY_CATEGORY, "New York");
