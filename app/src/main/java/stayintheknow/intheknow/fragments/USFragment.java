...
public class USFragment extends Fragment {private SwipeRefreshLayout swipeContainer;
    ...
    private void queryArticles() {
        ...
        /*Fetch from api*/
        NYTArticleAPI.getNYTArticles("U.S.");
        ...
        articleQuery.whereEqualTo(Article.KEY_CATEGORY, "U.S.");
